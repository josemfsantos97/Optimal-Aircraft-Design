...
upper_x = np.array([0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6], dtype = 'complex128')
lower_x = np.array([0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6], dtype = 'complex128')
upper_y = np.array([0.036700, 0.041700, 0.045100, 0.047400, 0.048900, 0.049700, 0.050000, 0.049700, 0.048800, 0.047400, 0.045300], dtype = 'complex128')
lower_y = np.array([-0.036700, -0.041800, -0.045200, -0.047600, -0.049100, -0.049800, -0.049600, -0.048600, -0.046500, -0.043100, -0.037800 ], dtype = 'complex128')
...
surf_dict = {
            ...
            'c_max_t' : .37,       # chordwise location of maximum thickness
...
indep_var_comp.add_output('W0_without_point_masses', val=19724.5 + surf_dict['Wf_reserve'],  units='kg')
...
prob.model.add_design_var('wing.geometry.t_over_c_cp', lower=0.02, upper=0.2, scaler=10.)
prob.model.add_design_var('alpha_maneuver', lower=-15., upper=15)


prob.model.add_constraint('AS_point_0.CL', lower=0.4)
...
recorder = SqliteRecorder("1st_opt1.db")
